...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        ...
        <p> 같은 나이대가 좋아하는 영화
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <c:forEach var="movieItem" items="${movies2}">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
        ...
        <p> 유저 기반 협업 필터링 알고리즘
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <c:forEach var="movieItem" items="${movies3}">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
        ...
        <p> 시청 이력이 있는 장르의 영화
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <c:forEach var="movieItem" items="${movies4}">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
        ...
        <p> 가장 최근에 평점을 매긴 영화와 유사한 영화
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <c:forEach var="movieItem" items="${movies5}">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
